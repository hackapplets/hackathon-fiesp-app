    ...
    <section class="section login-page__form-container">
      <section class="box login-page__form-content">
        ...
        <form @submit.prevent="submit" class="login-page__form">
          ...
          <p class="control">
            <input v-model="email" id="login-page__email-input" class="input is-primary" type="email" autofocus>
          </p>
          <label for="login-page__password-input" class="label">Senha</label>
          <p class="control">
            <input v-model="password" id="login-page__password-input" class="input is-primary" type="password">
          </p>
          ...
          <p class="control">
            ...
            <button type="submit" class="button is-primary is-outlined">Entrar</button>
          </p>
        </form>
      </section>
    </section>
